...
class SellClothesView1: UIView {
    ...
    override func layoutSubviews() {
        ...
        layer.mask = mask
        postButton.layer.cornerRadius = postButton.frame.width / 16
    }
    ...
    override func didMoveToSuperview() {
        ...
        self.addSubview(separatorView4)
    ...
    func setupConstraints() {
        ...
        separatorView3.snp.makeConstraints { (make) in
            make.top.equalTo(brandTextField.snp.bottom)
            make.width.equalToSuperview().multipliedBy(0.9)
            make.centerX.equalToSuperview()
            make.height.equalTo(1)
        }
        ...
        descriptionTextView.snp.makeConstraints { (make) in
            ...
            make.height.equalToSuperview().multipliedBy(0.1)
            make.top.equalTo(brandTextField.snp.bottom).offset(padding / 2)
        }
